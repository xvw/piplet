...
module Monad :
sig
  include module type of Interfaces.Monad
  module Join : functor (M : JOIN) -> BASIC_INTERFACE
  module Bind : functor (M : BIND) -> BASIC_INTERFACE
  module With : functor (M : BASIC_INTERFACE) -> INTERFACE
